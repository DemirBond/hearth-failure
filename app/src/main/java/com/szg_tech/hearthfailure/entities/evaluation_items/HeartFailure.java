                ...
                add(new SectionEvaluationItem(context, ConfigurationParams.CHANGE_IT, "Clinical Presentation", false, new ArrayList<EvaluationItem>() {
                    {
                        ...
                        add(new NumericalEvaluationItem(context, ConfigurationParams.CHANGE_IT, "RA O2sat%", context.getString(R.string.value), 10, 80, false, true));
                        ...
                        add(new BooleanEvaluationItem(context, ConfigurationParams.CHANGE_IT, "Dyspnea on Exertion, not at Rest", false));
                        add(new BooleanEvaluationItem(context, ConfigurationParams.CHANGE_IT, "Dyspnea at Rest / Orthopnea", false));
                        add(new BooleanEvaluationItem(context, ConfigurationParams.CHANGE_IT, "Hepatojugular Reflux", false));
                        add(new BooleanEvaluationItem(context, ConfigurationParams.CHANGE_IT, "Jugular Venous Distention", false));
                        add(new BooleanEvaluationItem(context, ConfigurationParams.CHANGE_IT, "Edema/Ascites", false));
                        add(new BooleanEvaluationItem(context, ConfigurationParams.CHANGE_IT, "Left Sided Gallop", false));
                        add(new BooleanEvaluationItem(context, ConfigurationParams.CHANGE_IT, "New Rales", false));
                        add(new BooleanEvaluationItem(context, ConfigurationParams.CHANGE_IT, "Pulmonary Edema", false));
                        add(new BooleanEvaluationItem(context, ConfigurationParams.CHANGE_IT, "Low Urine Output < 30ml/hr", false));
                        add(new BooleanEvaluationItem(context, ConfigurationParams.CHANGE_IT, "Any CNS Symptoms", false));
                        add(new BooleanEvaluationItem(context, ConfigurationParams.CHANGE_IT, "Cold Clammy Extremities", false));
